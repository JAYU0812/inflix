        ...
        >
          {!success ? (
            <>
              ...
              >
                Join INFLIX to stream in high-fidelity.
              </p>
            ...
            <div style={{ textAlign: "center", padding: "10px 0" }}>
              ...
              <p style={{ fontSize: "14px", color: "#8B9E95", margin: 0, lineHeight: "1.6" }}>
                Welcome to INFLIX. You can now log in and start watching. Redirecting you to login...
              </p>
            </div>
          )}
        </div>
